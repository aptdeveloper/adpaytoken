    ...
    render() {
        return <LinearGradient style={styles.container} colors={['rgb(55,163,255)', 'rgb(82,112,253)']}>
            <ScrollView showsVerticalScrollIndicator={false} >
                ...
                <TouchableHighlight onPress={this.onBack} underlayColor="rgb(55,163,255)">
                ...
                <View style={styles.styles_v2}>
                    ...
                    <Text style={styles.tex6}>518963</Text>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        >
                            <Text style={styles.tex7}>复制邀请链接</Text>
                        </LinearGradient>
                        <LinearGradient
                            style={[styles.img4, { marginLeft: 30 * unitWidth }]}
                            colors={['rgb(255,188,43)', 'rgb(255,160,38)']}
                        >
                            <Text style={styles.tex7}>生成邀请卡</Text>
                        </LinearGradient>
                    </View>
                ...
                <View style={[styles.styles_v5, { height: 444 * unitHeight }]}>
                    <View style={styles.notes_styles}>
                        <Image source={require('../../img/push_style.png')} style={styles.push_styles} />
                        <Text style={styles.noets_text_styles} onPress={() => Actions.apprentice()}>我的邀请记录</Text>
                        <Image source={require('../../img/push_style.png')} style={styles.push_styles} />
                    </View>
                    <Text style={styles.tex12}>累计共<Text style={[styles.tex12, { color: "rgb(53,126,220)" }]}> 60 </Text>算力</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                        <View >
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={styles.tex12} >徒弟数 <Text style={[styles.tex12, { color: "rgb(53,126,220)" }]}>5</Text></Text>
                            </View>
                            <View style={styles.viewstyles}>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                                    <View style={{ justifyContent: 'center', alignSelf: 'center', marginTop: 20 * unitHeight }}>
                                        ...
                                        <Text style={styles.tex14}>50</Text>
                                    </View>
                                    <View style={{ justifyContent: 'center', alignSelf: 'center', marginTop: 20 * unitHeight }}>
                        ...
                        <View style={{ marginLeft: 52 * unitWidth }} >
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={styles.tex12}>徒孙数 <Text style={[styles.tex12, { color: "rgb(53,126,220)" }]}>2</Text></Text>
                            </View>
                            <View style={styles.viewstyles}>
                                <Text style={styles.tex13}>累计获得</Text>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                ...
                {/* <View style={styles.styles_v6}>
                    <View style={styles.styles_v7}>
                        <Text style={styles.tex10}>我的奖励</Text>
                        <Text style={styles.tex11}>查看更多</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginLeft: 151 * unitWidth, marginRight: 151 * unitWidth }}>
                        <View style={styles.styles_v8}>
                            <Text style={{
                                fontSize: 60 * unitWidth,
                                color: "#33363b",
                                fontFamily: "Montserrat-Regular",
                                fontWeight: 'bold'
                            }}>{this.state.totalIncome}<Text style={{ fontSize: 26 * unitWidth, color: "#33363b", fontFamily: "PingFangTC", }}>APT</Text></Text>
                            <Text style={{
                        ...
                        <View style={styles.styles_v8}>
                            <Text style={{
                                ...
                                fontFamily: "Montserrat-Regular",
                                fontWeight: 'bold'
                            }}>{this.state.num}<Text style={{ fontSize: 26 * unitWidth, color: "#33363b", fontFamily: "PingFangTC", }}>人</Text></Text>
                            <Text style={{
                                fontSize: 22 * unitWidth,
                                color: "#626970",
                                fontFamily: "PingFangTC",
...
const styles = StyleSheet.create({
    ...
    styles_v5: {
        width: 660 * unitWidth,
        height: 450 * unitWidth,
        marginTop: 41 * unitWidth,
        alignSelf: 'center',
        marginBottom: 40 * unitWidth,
        elevation: 6,  
        shadowColor: "rgba(79, 118, 253, 0.53)",
        shadowOffset: { width: 0, height: 0 },  
        shadowOpacity: 1, 
